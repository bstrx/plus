...
Разница между этими параметрами и параметром "Доступность" является то, что вне указанного диапазона дат студенты смогут видеть описание элемента, тогда как параметр "Доступность" предотвращает доступ полностью.';
