...
$string['coursedisplay_help'] = 'Этот параметр определяет, будет ли весь курс отображаться на одной странице или будет разделен на несколько страниц. Настройка не влияет на некоторые форматы курса, такие как формат SCORM.';
...
$string['selectmoduletoviewhelp'] = 'Выберите модуль для просмотра справки.';
