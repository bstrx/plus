...
$string['suspended'] = 'Приостановленный аккаунт';
$string['suspended_help'] = 'Пользователь с приостановленным аккаунтом не может войти в систему и использовать веб-сервисы. Все сообщения ему блокируются.';
