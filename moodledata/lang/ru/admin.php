...
$string['configcourseswithsummarieslimit'] = 'Максимальное количество курсов, которые отображаются с описанием. Последующие курсы - просто список названий.';
...
$string['confignavshowallcourses'] = 'Если включено, то пользователи будут видеть курсы, на которые они записаны и в навигации "Мои курсы" и в структуре курса. При отключенном параметре записанные пользователи будут видеть свои курсы только в навигации "Мои курсы".';
...
$string['courseswithsummarieslimit'] = 'Количество курсов с описанием';
...
$string['navshowmycoursecategories_help'] = 'При включенном параметре "Мои курсы" будут отображаться в категориях';
...
$string['register'] = 'Зарегистрируйте свой сайт';
$string['registermoodleorg'] = 'При регистрации своего сайта в {$a}';
...
$string['registermoodleorgli3'] = 'Ваш сайт также будет зарегистрирован в Открытом сообществе Moodle - MOOCH ({$a}), что позволит пользователям с правами публикации курсов (по умолчанию - только Управляющие)  опубликовать свои курсы в MOOCH.';
$string['registerwithmoodleorg'] = 'Зарегистрировать в Moodle.org';
...
$string['suspenduser'] = 'Приостановить учётную запись пользователя';
...
$string['updateavailablenot'] = 'Похоже, что у Вас установлена последняя версия Moodle';
