...
if (!empty($paymentsystem[3]))
{
	$paymentsystemparams .= "paymentSystem.limitIds={$paymentsystem[3]}&";
}
if (!empty($paymentsystem[4]))
{
	$paymentsystemparams .= "paymentSystem.accountId={$paymentsystem[4]}&";
}
