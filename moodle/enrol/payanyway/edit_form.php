...
class enrol_payanyway_edit_form extends moodleform {
    ...
    function definition() {
		...
		$paymentsystems = array(
			'payanyway' => get_string('payanyway', 'enrol_payanyway'),
			'banktransfer_1_1030_1030_5' => get_string('banktransfer', 'enrol_payanyway'),
			'ciberpay_1_489755_489755_19357960' => get_string('ciberpay', 'enrol_payanyway'),
			'comepay_1_228820_228820_47654606' => get_string('comepay', 'enrol_payanyway'),
			'contact_1_1028_1028_26' => get_string('contact', 'enrol_payanyway'),
			'elecsnet_1_232821_232821_10496472' => get_string('elecsnet', 'enrol_payanyway'),
			'euroset_1_248362_248362_136' => get_string('euroset', 'enrol_payanyway'),
			'forward_1_83046_83046_116' => get_string('forward', 'enrol_payanyway'),
			'gorod_1_426904_426904_152' => get_string('gorod', 'enrol_payanyway'),
			'mcb_1_295339_295339_143' => get_string('mcb', 'enrol_payanyway'),
			'moneta_0_1015_1015_94' => get_string('moneta', 'enrol_payanyway'),
			'moneymail_0_1038_1038_29' => get_string('moneymail', 'enrol_payanyway'),
			'novoplat_1_281129_281129_80314912' => get_string('novoplat', 'enrol_payanyway'),
			'plastic_0_499669_499669_159' => get_string('plastic', 'enrol_payanyway'),
			'platika_1_226272_226272_15662295' => get_string('platika', 'enrol_payanyway'),
			'post_1_1029_1029_15' => get_string('post', 'enrol_payanyway'),
			'wallet_0_310212_310212_153' => get_string('wallet', 'enrol_payanyway'),
			'webmoney_0_1017_1017' => get_string('webmoney', 'enrol_payanyway'),
			'yandex_0_1020_1020_16' => get_string('yandex', 'enrol_payanyway'),
		);
